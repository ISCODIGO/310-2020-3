/*
 * Esta clase permita coleccionar nodos. Se conocen unicamente el primero
 * y el ultimo de la lista. Los que estan intermedios solo pueden conocerse
 * mediante la iteración O(n) de los elementos. Se definen las 4 operaciones
 * básicas de la estructura (manipular sus extremos).
 * 
 */
